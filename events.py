...
class Events:
    ...
    async def post_stats(self):
        ...
        dbots_org_header = {'Authorization': "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2MTQxMjAxNjMxMjg1MjQ4IiwiaWF0IjoxNTAwNTU4MTE5fQ.e-Yh1jzGMXOIQl0DkiG2QL5GOxK_wAKf3aaX7ZKiBV4", 'Content-Type': 'application/json'}
        dbots_payload = json.dumps({'server_count': len(self.bot.guilds)})
        sharded_guilds = collections.Counter(x.shard_id for x in self.bot.guilds)
        d = []
